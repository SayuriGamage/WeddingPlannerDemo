        ...
        fetch(`http://localhost:8080/api/v1/auth/verify-otp?email=${email}&otp=${otp}`, {
            ...
            .then(data => {
                if (data === "OTP verified successfully") {
                    ...
                    window.location.href = 'http://localhost:63342/WeddingPlannerDemo/html/admin/newPassword.html?_ijt=80jv2b5ouo0pa67pc2aisch8ck&_ij_reload=RELOAD_ON_SAVE';
                } else {
                    alert(data);
                }
            })
...
// new-password.js
    ...
    document.getElementById('new-password-submit').addEventListener('click', function (e) {
        ...
        fetch(`http://localhost:8080/api/v1/auth/reset-password?email=${email}&newPassword=${newPassword}`, {
            method: 'POST'
